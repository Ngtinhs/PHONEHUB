...
namespace eShopSolution.WebApp.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterRequest registerRequest)
        {
            ...
            //var message = await MailUtils.MailUtils.SendGmail("contact.phonehub.vn@gmail.com", user.ResultObj.Email,
            //                                                  "Link xác nhận email", confirmationLink,
            //                                                  "your_email_here", "your_password_here");

            var email = new EmailService.EmailService();
            email.Send("contact.phonehub.vn@gmail.com", user.ResultObj.Email, "XÁC NHẬN TÀI KHOẢN", confirmationLink);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel request)
        {
            ...
            //var message = await MailUtils.MailUtils.SendGmail("contact.phonehub.vn@gmail.com", request.Email,
            //                                            "Link khôi phục mật khẩu", passwordResetLink,
            //                                            "your_email_here", "your_password_here");

            var email = new EmailService.EmailService();
            email.Send("contact.phonehub.vn@gmail.com", request.Email, "Link khôi phục mật khẩu", passwordResetLink);
